...
let array: [[Int]] = [[ 8, 2,22,97,38,15, 0,40, 0,75, 4, 5, 7,78,52,12,50,77,91, 8],
...
for i in array.startIndex ..< array.endIndex {
    for j in array.startIndex ..< array.endIndex {
        
        if j < array.endIndex - 3 {
            var product = 1
            for k in 0 ... 3 {
                product *= array[i][j+k]
...
print("The largest product is \(largestProduct)")
