  ...
  public static void main(String[] args) {
    ...
    for (int i = 0; i < GRID_SIZE; i++) {
      for (int j = 0; j < GRID_SIZE; j++) {
        System.out.println("Processing number " + grid[i][j]);
        int temp = 1;

        if (i < (GRID_SIZE - 3)) {
          System.out.println("Multiplying downwards");
          temp = 1;
          for (int a = 0; a < 4; a++) {
            temp *= grid[i+a][j];
          ...
          if (j < (GRID_SIZE - 3)) {
            System.out.println("Multiplying diagonally forward");
            temp = 1;
            for (int a = 0; a < 4; a++) {
              temp *= grid[i+a][j+a];
              System.out.println("Product: " + temp);
          ...
          if (j > 2) {
            System.out.println("Multiplying diagonally backwards");
            temp = 1;
            for (int a = 0; a < 4; a++) {
              temp *= grid[i+a][j-a];
              System.out.println("Product: " + temp);
        ...
        if (j < (GRID_SIZE - 3)) {
          System.out.println("Multiplying right");
          temp = 1;
          for (int b = 0; b < 4; b++) {
            temp *= grid[i][j+b];
            System.out.println("Product: " + temp);
